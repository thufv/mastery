...
public interface CListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CParser#declarationSpecifierDecorators}.
	 * @param ctx the parse tree
	 */
	void enterDeclarationSpecifierDecorators(CParser.DeclarationSpecifierDecoratorsContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#declarationSpecifierDecorators}.
	 * @param ctx the parse tree
	 */
	void exitDeclarationSpecifierDecorators(CParser.DeclarationSpecifierDecoratorsContext ctx);
	/**
	 * Enter a parse tree produced by {@link CParser#finalDeclarationSpecifier}.
	 * @param ctx the parse tree
	 */
	void enterFinalDeclarationSpecifier(CParser.FinalDeclarationSpecifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#finalDeclarationSpecifier}.
	 * @param ctx the parse tree
	 */
	void exitFinalDeclarationSpecifier(CParser.FinalDeclarationSpecifierContext ctx);
	/**
