...
public class CPAchecker {
    ...
    private static class CPAcheckerOptions {
        ...
        // algorithm options@Option(name="analysis.traversal.order")
   ...
   */
    ...
    public CPAcheckerResult run(String filename) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Could not read file", filename, (e.getMessage() != null ? "(" + e.getMessage() + ")" : ""));
   ...
   */
    ...
    private Result runAlgorithm(final Algorithm algorithm, final ReachedSet reached, final MainCPAStatistics stats) throws CPAException {
    ...
    private Algorithm createAlgorithm(final Map<String, CFAFunctionDefinitionNode> cfas, final ConfigurableProgramAnalysis cpa, MainCPAStatistics stats) throws InvalidConfigurationException, CPAException {
    ...
    private ReachedSet createInitialReachedSet(final ConfigurableProgramAnalysis cpa, final CFAFunctionDefinitionNode mainFunction) {
